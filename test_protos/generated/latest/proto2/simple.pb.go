...
// 	protoc        v3.21.7
// source: test_protos/schema/proto2/simple.proto
...
func (x *Empty) Reset() {
	*x = Empty{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_protos_schema_proto2_simple_proto_msgTypes[0]
...
func (*Empty) Descriptor() ([]byte, []int) {
	return file_test_protos_schema_proto2_simple_proto_rawDescGZIP(), []int{0}
}
...
func (x *Simple) Reset() {
	*x = Simple{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_protos_schema_proto2_simple_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Simple) Descriptor() ([]byte, []int) {
	return file_test_protos_schema_proto2_simple_proto_rawDescGZIP(), []int{1}
}
...
func (x *Repetitive) Reset() {
	*x = Repetitive{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_protos_schema_proto2_simple_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Repetitive) Descriptor() ([]byte, []int) {
	return file_test_protos_schema_proto2_simple_proto_rawDescGZIP(), []int{2}
}
...
func (x *Singleton) Reset() {
	*x = Singleton{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_protos_schema_proto2_simple_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Singleton) Descriptor() ([]byte, []int) {
	return file_test_protos_schema_proto2_simple_proto_rawDescGZIP(), []int{3}
}
...
var File_test_protos_schema_proto2_simple_proto protoreflect.FileDescriptor

var file_test_protos_schema_proto2_simple_proto_rawDesc = []byte{
	0x0a, 0x26, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x2f, 0x73, 0x69, 0x6d, 0x70,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79,
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x2e, 0x52, 0x65, 0x70,
	...
	0x32, 0x2e, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x74, 0x6f, 0x6e, 0x52, 0x0e, 0x73, 0x69, 0x6e,
	...
	0x68, 0x65, 0x6d, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x2e, 0x52, 0x65, 0x70, 0x65,
...
var (
	file_test_protos_schema_proto2_simple_proto_rawDescOnce sync.Once
	file_test_protos_schema_proto2_simple_proto_rawDescData = file_test_protos_schema_proto2_simple_proto_rawDesc
)

func file_test_protos_schema_proto2_simple_proto_rawDescGZIP() []byte {
	file_test_protos_schema_proto2_simple_proto_rawDescOnce.Do(func() {
		file_test_protos_schema_proto2_simple_proto_rawDescData = protoimpl.X.CompressGZIP(file_test_protos_schema_proto2_simple_proto_rawDescData)
	})
	return file_test_protos_schema_proto2_simple_proto_rawDescData
}

var file_test_protos_schema_proto2_simple_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_test_protos_schema_proto2_simple_proto_goTypes = []interface{}{
...
var file_test_protos_schema_proto2_simple_proto_depIdxs = []int32{
...
func init() { file_test_protos_schema_proto2_simple_proto_init() }
func file_test_protos_schema_proto2_simple_proto_init() {
	if File_test_protos_schema_proto2_simple_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_test_protos_schema_proto2_simple_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_test_protos_schema_proto2_simple_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Simple); i {
			case 0:
				return &v.state
			case 1:
		...
		file_test_protos_schema_proto2_simple_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_test_protos_schema_proto2_simple_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_test_protos_schema_proto2_simple_proto_msgTypes[3].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_test_protos_schema_proto2_simple_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_test_protos_schema_proto2_simple_proto_goTypes,
		DependencyIndexes: file_test_protos_schema_proto2_simple_proto_depIdxs,
		MessageInfos:      file_test_protos_schema_proto2_simple_proto_msgTypes,
	}.Build()
	File_test_protos_schema_proto2_simple_proto = out.File
	file_test_protos_schema_proto2_simple_proto_rawDesc = nil
	file_test_protos_schema_proto2_simple_proto_goTypes = nil
	file_test_protos_schema_proto2_simple_proto_depIdxs = nil
}
