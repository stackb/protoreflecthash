...
// 	protoc        v3.21.7
// source: test_protos/schema/proto2/well_known_types.proto
...
func (x *KnownTypes) Reset() {
	*x = KnownTypes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_protos_schema_proto2_well_known_types_proto_msgTypes[0]
...
func (*KnownTypes) Descriptor() ([]byte, []int) {
	return file_test_protos_schema_proto2_well_known_types_proto_rawDescGZIP(), []int{0}
}
...
var File_test_protos_schema_proto2_well_known_types_proto protoreflect.FileDescriptor

var file_test_protos_schema_proto2_well_known_types_proto_rawDesc = []byte{
	0x0a, 0x30, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x2f, 0x77, 0x65, 0x6c, 0x6c,
...
var (
	file_test_protos_schema_proto2_well_known_types_proto_rawDescOnce sync.Once
	file_test_protos_schema_proto2_well_known_types_proto_rawDescData = file_test_protos_schema_proto2_well_known_types_proto_rawDesc
)

func file_test_protos_schema_proto2_well_known_types_proto_rawDescGZIP() []byte {
	file_test_protos_schema_proto2_well_known_types_proto_rawDescOnce.Do(func() {
		file_test_protos_schema_proto2_well_known_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_test_protos_schema_proto2_well_known_types_proto_rawDescData)
	})
	return file_test_protos_schema_proto2_well_known_types_proto_rawDescData
}

var file_test_protos_schema_proto2_well_known_types_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_test_protos_schema_proto2_well_known_types_proto_goTypes = []interface{}{
...
var file_test_protos_schema_proto2_well_known_types_proto_depIdxs = []int32{
...
func init() { file_test_protos_schema_proto2_well_known_types_proto_init() }
func file_test_protos_schema_proto2_well_known_types_proto_init() {
	if File_test_protos_schema_proto2_well_known_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_test_protos_schema_proto2_well_known_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_test_protos_schema_proto2_well_known_types_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_test_protos_schema_proto2_well_known_types_proto_goTypes,
		DependencyIndexes: file_test_protos_schema_proto2_well_known_types_proto_depIdxs,
		MessageInfos:      file_test_protos_schema_proto2_well_known_types_proto_msgTypes,
	}.Build()
	File_test_protos_schema_proto2_well_known_types_proto = out.File
	file_test_protos_schema_proto2_well_known_types_proto_rawDesc = nil
	file_test_protos_schema_proto2_well_known_types_proto_goTypes = nil
	file_test_protos_schema_proto2_well_known_types_proto_depIdxs = nil
}
