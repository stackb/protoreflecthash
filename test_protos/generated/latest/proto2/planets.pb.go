...
// 	protoc        v3.21.7
// source: test_protos/schema/proto2/planets.proto
...
func (PlanetV1) Descriptor() protoreflect.EnumDescriptor {
	return file_test_protos_schema_proto2_planets_proto_enumTypes[0].Descriptor()
}

func (PlanetV1) Type() protoreflect.EnumType {
	return &file_test_protos_schema_proto2_planets_proto_enumTypes[0]
}
...
func (PlanetV1) EnumDescriptor() ([]byte, []int) {
	return file_test_protos_schema_proto2_planets_proto_rawDescGZIP(), []int{0}
}
...
func (PlanetV2) Descriptor() protoreflect.EnumDescriptor {
	return file_test_protos_schema_proto2_planets_proto_enumTypes[1].Descriptor()
}

func (PlanetV2) Type() protoreflect.EnumType {
	return &file_test_protos_schema_proto2_planets_proto_enumTypes[1]
}
...
func (PlanetV2) EnumDescriptor() ([]byte, []int) {
	return file_test_protos_schema_proto2_planets_proto_rawDescGZIP(), []int{1}
}
...
func (PlanetV3) Descriptor() protoreflect.EnumDescriptor {
	return file_test_protos_schema_proto2_planets_proto_enumTypes[2].Descriptor()
}

func (PlanetV3) Type() protoreflect.EnumType {
	return &file_test_protos_schema_proto2_planets_proto_enumTypes[2]
}
...
func (PlanetV3) EnumDescriptor() ([]byte, []int) {
	return file_test_protos_schema_proto2_planets_proto_rawDescGZIP(), []int{2}
}
...
func (x *MyFavoritePlanetsV1) Reset() {
	*x = MyFavoritePlanetsV1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_protos_schema_proto2_planets_proto_msgTypes[0]
...
func (x *MyFavoritePlanetsV2) Reset() {
	*x = MyFavoritePlanetsV2{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_protos_schema_proto2_planets_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *MyFavoritePlanetsV3) Reset() {
	*x = MyFavoritePlanetsV3{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_protos_schema_proto2_planets_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var File_test_protos_schema_proto2_planets_proto protoreflect.FileDescriptor

var file_test_protos_schema_proto2_planets_proto_rawDesc = []byte{
	0x0a, 0x27, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x2f, 0x70, 0x6c, 0x61, 0x6e,
	0x65, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x73, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x22, 0x48, 0x0a, 0x13, 0x4d, 0x79, 0x46, 0x61,
	...
	0x6f, 0x74, 0x6f, 0x32, 0x2e, 0x50, 0x6c, 0x61, 0x6e, 0x65, 0x74, 0x56, 0x33, 0x52, 0x07, 0x70,
...
var (
	file_test_protos_schema_proto2_planets_proto_rawDescOnce sync.Once
	file_test_protos_schema_proto2_planets_proto_rawDescData = file_test_protos_schema_proto2_planets_proto_rawDesc
)

func file_test_protos_schema_proto2_planets_proto_rawDescGZIP() []byte {
	file_test_protos_schema_proto2_planets_proto_rawDescOnce.Do(func() {
		file_test_protos_schema_proto2_planets_proto_rawDescData = protoimpl.X.CompressGZIP(file_test_protos_schema_proto2_planets_proto_rawDescData)
	})
	return file_test_protos_schema_proto2_planets_proto_rawDescData
}

var file_test_protos_schema_proto2_planets_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_test_protos_schema_proto2_planets_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_test_protos_schema_proto2_planets_proto_goTypes = []interface{}{
...
var file_test_protos_schema_proto2_planets_proto_depIdxs = []int32{
...
func init() { file_test_protos_schema_proto2_planets_proto_init() }
func file_test_protos_schema_proto2_planets_proto_init() {
	if File_test_protos_schema_proto2_planets_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_test_protos_schema_proto2_planets_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_test_protos_schema_proto2_planets_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_test_protos_schema_proto2_planets_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_test_protos_schema_proto2_planets_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_test_protos_schema_proto2_planets_proto_goTypes,
		DependencyIndexes: file_test_protos_schema_proto2_planets_proto_depIdxs,
		EnumInfos:         file_test_protos_schema_proto2_planets_proto_enumTypes,
		MessageInfos:      file_test_protos_schema_proto2_planets_proto_msgTypes,
	}.Build()
	File_test_protos_schema_proto2_planets_proto = out.File
	file_test_protos_schema_proto2_planets_proto_rawDesc = nil
	file_test_protos_schema_proto2_planets_proto_goTypes = nil
	file_test_protos_schema_proto2_planets_proto_depIdxs = nil
}
